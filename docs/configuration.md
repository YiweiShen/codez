...
| `openai-model`                | OpenAI model identifier to use (default: `gpt-5.4`)                                                                                                                                      |
| `openai-commit-message-model` | OpenAI model identifier used to generate commit messages (default: `gpt-5.4`)                                                                                                            |
